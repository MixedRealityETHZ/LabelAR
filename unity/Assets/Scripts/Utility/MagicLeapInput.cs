...
public partial class @MagicLeapInput: IInputActionCollection2, IDisposable
{
    ...
    ~@MagicLeapInput()
    {
        UnityEngine.Debug.Assert(!m_HMD.enabled, "This will cause a leak and performance issues, MagicLeapInput.HMD.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Controller.enabled, "This will cause a leak and performance issues, MagicLeapInput.Controller.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Eyes.enabled, "This will cause a leak and performance issues, MagicLeapInput.Eyes.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_LeftHand.enabled, "This will cause a leak and performance issues, MagicLeapInput.LeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_RightHand.enabled, "This will cause a leak and performance issues, MagicLeapInput.RightHand.Disable() has not been called.");
    }
